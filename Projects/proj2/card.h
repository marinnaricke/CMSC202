...
class Card 
{
 ...
 public:
  ...
  // PostCondition: Returns suit of the host card
  cSuit suit() ;

  // Name: points
  // PreCondition: No precondition
  // PostCondition: Returns point value of the host Card.
  cPoints points() ; 

  // Name: print
  // PreCondition: No precondition
  // PostCondition: Prints a description of the
  //  host card to standard output
  void print() ;    
